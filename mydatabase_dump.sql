...
--
-- Name: whereanimalownercategorydog_comparison_dog_table; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.whereanimalownercategorydog_comparison_dog_table (
    word text NOT NULL,
    synonym text NOT NULL
);


ALTER TABLE public.whereanimalownercategorydog_comparison_dog_table OWNER TO postgres;
...
--
-- Data for Name: whereanimalownercategorydog_comparison_dog_table; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.whereanimalownercategorydog_comparison_dog_table (word, synonym) FROM stdin;
dog	chien
dog	chat
dog	dog
dog	perro
