...
#MAIN FUNCTION
def row_calculus_pipeline(queries):
    retries = 0
    output=[]
    ...
    filepath = os.path.join(os.getcwd(),"temporary", "Test_creation") #Construct the full path
...
queries=["∃id ∃name ∃patients_pd (doctors(id, name, patients_pd) ∧ patients_pd < 12)",
